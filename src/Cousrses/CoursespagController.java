...
public class CoursespagController implements Initializable {
    ...
    private void loadCourses() {
        ObservableList<Product> products = FXCollections.observableArrayList(Product.getAllProducts("corses"));
    ...
    @FXML private void pdf_btn(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/PDFLib/pdfliib.fxml"));
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.setScene(new Scene(root));
        stage.show();
    }
    ...
    @FXML private void Courses_btn(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/Cousrses/coursespag.fxml"));
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.setScene(new Scene(root));
        stage.show();
    }
